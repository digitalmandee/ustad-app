                        ...
                        <Table style={{ border: "1px solid #e0e0e0" }}>
                            ...
                            <TableBody>
                                {childrenData.map((row) => (
                                    <TableRow key={row.id} style={{ borderBottom: "1px solid #e0e0e0" }}>
                                        <TableCell style={{ fontSize: "16px", color: '#101219', fontWeight: 400, border: "1px solid #e0e0e0" }}>{row.childName}</TableCell>
                        ...
                        <div className="col-12">
                            ...
                            >
                                ...
                                <div className="row mt-5">
                                    ...
                                    <div className="col-3">
                                        <div>
                                            <div style={{ fontSize: "14px", fontWeight: 500, color: "#80878A", marginBottom: "5px" }}>Children</div>
                                            <TextField
                                    ...
                                    <div className="col-3">
                                        <div>
                                            <div style={{ fontSize: "14px", fontWeight: 500, color: "#80878A", marginBottom: "5px" }}>Amount Spent All Time</div>
                                            <TextField
                            ...
                            <div style={{ paddingTop: "10px" }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Tab label="Children 43" />
                                        <Tab label="Notes by Tutors 36" />
                                    </Tabs>
                                </Box>
