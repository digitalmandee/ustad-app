                                        ...
                                        {tableData.map((row, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell style={{
                                                        fontSize: "16px", color: "#101219", fontWeight: 400, border: "1px solid #e0e0e0", py: 0,
                                                        height: 48,
                                                    }}>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            {row.price}
                                                    ...
                                                    <TableCell style={{
                                                        fontSize: "16px", color: "#4D5874", fontWeight:400, border: "1px solid #e0e0e0", py: 0,
                                                        height: 48,
                                                    }}>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            {row.date}
