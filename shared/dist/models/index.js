...
const HelpRequests_1 = require("./HelpRequests");
...
const UserReport_1 = require("./UserReport");
Object.defineProperty(exports, "UserReport", { enumerable: true, get: function () { return UserReport_1.UserReport; } });
...
function initAllModels(sequelize) {
    ...
    (0, UserReport_1.initUserReportModel)(sequelize);
    (0, UserBlock_1.initUserBlockModel)(sequelize);
